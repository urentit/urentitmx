...
import { calcGps, calcSeguroCarga, calcServiciosPreventivos, calcTenencias, calcCore } from '../engine'
...
export function calculate(input: QuoteInput, user: QuoteUser, years: 36 | 48): QuoteResult {
  ...
  const seguro     = seguroManual != null ? seguroManual * yrs : calcSeguroCarga(total, yrs)
